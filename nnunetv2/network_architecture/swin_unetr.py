...
class SwinUNETR(nn.Module):
    ...
    def load_from(self, weights):
        layers1_0: BasicLayer = self.swinViT.layers1[0]
        layers2_0: BasicLayer = self.swinViT.layers2[0]
        layers3_0: BasicLayer = self.swinViT.layers3[0]
        layers4_0: BasicLayer = self.swinViT.layers4[0]
        ...
        with torch.no_grad():
            ...
            if layers1_0.downsample is not None:
                ...
                d.reduction.weight.copy_(wstate["module.layers1.0.downsample.reduction.weight"])
                d.norm.weight.copy_(wstate["module.layers1.0.downsample.norm.weight"])
                d.norm.bias.copy_(wstate["module.layers1.0.downsample.norm.bias"])
            ...
            if layers2_0.downsample is not None:
                ...
                d.reduction.weight.copy_(wstate["module.layers2.0.downsample.reduction.weight"])
                d.norm.weight.copy_(wstate["module.layers2.0.downsample.norm.weight"])
                d.norm.bias.copy_(wstate["module.layers2.0.downsample.norm.bias"])
            ...
            if layers3_0.downsample is not None:
                ...
                d.reduction.weight.copy_(wstate["module.layers3.0.downsample.reduction.weight"])
                d.norm.weight.copy_(wstate["module.layers3.0.downsample.norm.weight"])
                d.norm.bias.copy_(wstate["module.layers3.0.downsample.norm.bias"])
            ...
            if layers4_0.downsample is not None:
                ...
                d.reduction.weight.copy_(wstate["module.layers4.0.downsample.reduction.weight"])
                d.norm.weight.copy_(wstate["module.layers4.0.downsample.norm.weight"])
                d.norm.bias.copy_(wstate["module.layers4.0.downsample.norm.bias"])
        ...
        for i_layer in range(self.num_layers):
            ...
            if self.use_v2:
                layerc = MedNeXtBlock(
                    ...
                    do_res=True,
                    norm_type='group',
                    dim='2d' if spatial_dims == 2 else '3d',
                )
                if i_layer == 0:
